...
export const PolicyModal: React.FC<PolicyModalProps> = ({ type, onClose }) => {
  ...
  const contentMap = {
    privacy: {
      ...
      icon: <Shield className="w-5 h-5 text-[#924a29]" />,
      text: (
    ...
    terms: {
      ...
      icon: <FileText className="w-5 h-5 text-[#924a29]" />,
      text: (
        <div className="space-y-3 text-sm text-[#434844] font-light leading-relaxed">
          <p>
    ...
    rules: {
      ...
      icon: <CheckCircle className="w-5 h-5 text-[#924a29]" />,
      text: (
        <div className="space-y-3 text-sm text-[#434844] font-light leading-relaxed">
          <p>
    ...
    accessibility: {
      title: 'הצהרת נגישות (Accessibility)',
      icon: <Eye className="w-5 h-5 text-[#924a29]" />,
      text: (
        <div className="space-y-3 text-sm text-[#434844] font-light leading-relaxed">
          <p>
            The Secret Rooftop רואה חשיבות עליונה בהנגשת שירותיה והמתחם לכלל הציבור, לרבות אנשים עם מוגבלויות.
          </p>
          <p>
            <strong>הסדרי נגישות במתחם:</strong> הגישה לקומת הגג מתאפשרת באמצעות מעלית. במתחם קיימים אזורי ישיבה נגישים לכיסאות גלגלים. שירותים נגישים ציבוריים של הבניין נמצאים בקומה שמתחת וניתן להגיע אליהם באמצעות המעלית.
          </p>
          <p>
            <strong>הנגשת האתר:</strong> האתר מותאם לגלישה באמצעות מקלדת, תומך בתוכנות קוראות מסך ועומד בהנחיות הנגישות WCAG 2.1 ברמה AA.
          </p>
        </div>
      ),
    },
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-[#fdf9f4] rounded-xl shadow-2xl border border-[#322206]/20 p-6 sm:p-8 z-10 text-right"
        >
