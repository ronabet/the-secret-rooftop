...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'הכתובת: היהלומים - מתחם יוקה פארק אשדוד - קומת הגג. חניה בשפע בחינם במתחם. ניתן לנווט ישירות דרך Google Maps. המקום נגיש במלואו עם מעלית ישירות לקומת הגג.',
  },
  {
